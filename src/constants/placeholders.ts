export const PLACEHOLDERS = {
  ...
  SCALES_CHANGE_TYPE: 'Change Type',
  SCALE_TYPE_WARNING_TITLE: 'Type Confirmation',
  SCALE_TYPE_WARNING_DESCRIPTION: 'Please carefully select the scale type. Once you have recorded data against a scale, you will not be able to change it. Are you sure you want to continue?',
  ...
  NO_SCALES_FOUND: 'No scales found',
  NO_DEEDS_TITLE: 'No Deeds Available',
  NO_RECORDS_TITLE: 'No Records Found',
  NO_RECORDS_DESCRIPTION: 'No records have been added yet for the selected date range.',
