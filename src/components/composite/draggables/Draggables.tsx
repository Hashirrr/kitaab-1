...
import { useGetHasanaatItems, useUpdateHasanaatItemDisplayOrder } from '@/hooks/deeds/hook';
...
export default function Draggables({ deedsData, variant }: DraggablesProps) {
  ...
  const { mutate: updateHasanaatItemDisplayOrder } = useUpdateHasanaatItemDisplayOrder();
  ...
  return (
    <div className={styles.container}>
      <DndContext
        ...
        onDragEnd={(event) => handleDragEnd({ event, setDeeds, updateHasanaatItemDisplayOrder })}
      >
