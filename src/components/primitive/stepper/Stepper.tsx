...
export default function Stepper({ id, visible }: StepperProps) {
  ...
  const deed = id ? getHasanaatItemsData?.find((item) => item.deed_item_id === id): getHasanaatItemsData?.at(0);
  ...
  return (
    <div className={styles.container}>
      ...
      <p className={styles.text}>Nothing to show yet. Add a deed to get started and see it here.</p>}
      <div className={styles.step}>
        <div className={clsx(styles.badge, { 
          [styles.is__active]: !(active === 0)
        })}>2</div>
